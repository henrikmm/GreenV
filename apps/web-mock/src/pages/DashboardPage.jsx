...
import { AnimatedNumber } from '@greenv/web-core'
import { TimeScrubber } from '@greenv/web-core'
import { ProgressChart } from '@greenv/web-core'
import { LevelDonut } from '@greenv/web-core'
import { TeamBarChart } from '@greenv/web-core'
import { MiniCorridorMap } from '@greenv/web-core'
import { EQUIPMENT_TYPES, formatArea } from '@greenv/web-core'
import { TEAMS } from '../data/mockTeams'
import { generateWeeklyProgress } from '../data/mockTrends'
import { estimateHistoricalCounts, estimateHistoricalLevel } from '../data/vegetationHistory'
      ...
      <div style={s.content}>
        ...
        <Card delay={0.1} style={{ marginBottom: 12 }}>
          ...
          <div style={{ ...s.timelineCard, marginTop: 14, marginBottom: 0 }}>
            <MiniCorridorMap geojson={geojson} levelOf={f => estimateHistoricalLevel(f, weeksAgo)} height={220} />
