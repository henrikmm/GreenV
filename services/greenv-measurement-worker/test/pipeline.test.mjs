...
test("a re-measure starts from the reconstruction kept beside the frames and wakes no GPU", async () => {
  ...
  assert.deepEqual(request().gridOptions, { maxHeightM: 3, canopyExtentM: 2, canopyGapM: 0.5, maxDistanceFromRoadM: 5.5, datum: "per-frame" }, "the ceilings, the gap, the band width and the datum travel as grid options");
