...
| `GREENV_MEASUREMENT_STRUCTURE_FLOOR` | `measurement_structure_floor`, default null | a pixel is a structure to the second model when the probability it gives those classes, summed, reaches this; unset leaves Verge Studio's 0.5 |
